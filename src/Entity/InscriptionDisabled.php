...
#[ORM\Entity(repositoryClass: InscriptionDisabledRepository::class)]
#[ORM\Table(name: 'inscription_disabled')]

class InscriptionDisabled
{
    ...
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'inscriptionsdisabled')]
    #[ORM\JoinColumn(nullable: false)]
    private ?User $user = null;

    #[ORM\Column(type: 'datetime')]
    private \DateTime $dateDesactivation;


    public function __construct()
    {   $this->dateDesactivation = new \DateTime();
...
*/
    ...
    public function getMotifDesactivation(): ?string
    {
        return $this->motifDesactivation;
    }

    public function setMotifDesactivation(string $motifDesactivation): static
    {
